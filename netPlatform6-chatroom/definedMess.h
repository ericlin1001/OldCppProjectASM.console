...
#define REGISTER_USER_SUCCESS		0
#define REGISTER_USER_HAVED_USER	1
#define REGISTER_USER_UNKNOWN		2
		char user[MAX_LEN_USERNAME];
		char pass[MAX_LEN_PASS];
		int errorType;
		bool isSuccess;
		UINT len(){return sizeof(RegisterUserData);}
...
public:
	...
	bool load(const char *user,const char *pass){
		ifstream infile;
