...
POrderFun orderFuns[]={menu,resetAll,showAll,showGivenPerson,showGivenType,showGiveTypePerson,addPerson,addType,delPerson,delType,setPeron,renameType,save,quit,help,clear,changePrintAfter,openFile};
char accessOrders[][MAX_LEN_ORDER+1]={"menu","resetAll","showAll","showGivenPerson","showGivenType","search","addPerson","addType","delPerson","delType","setPerson","resetType","save","quit","help","clear","printAfter","openFile"};
...
void renameType(){
	...
	cout<<"Change to:";
	getStr(cin,buffer,MAX_INPUT_BUFFER);
	db->setType(index,buffer,valueLen);
...
void initDB(){//just add some type.
	db->reset();
	dataBase.addType("Name",10);dataBase.addType("QQ",10);dataBase.addType("Phone",18);dataBase.addType("eamil",30);
}
